...
const CashIn = () => {
  ...
  const handleCashIn = async () => {
    ...
    const res = await AxiosPublic.post(
      'https://mobile-banking-tawny.vercel.app/api/transaction/cashIn',
      data
    )
  ...
  return (
    <div className='mx-auto bg-white  rounded-lg shadow-md '>
      ...
      <div className='border my-5 mt-20 text-black p-5'>
        <h3 className='text-lg font-semibold mb-2'>Use dammy User * copy *</h3>
        <ul className='space-y-2'>
          <li className='flex justify-between items-center p-3 bg-gray-100 rounded-md cursor-pointer hover:bg-gray-200'>
            <span className='text-blue-500'>01890143783</span>
          </li>
        </ul>
      </div>
