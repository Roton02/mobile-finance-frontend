  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        'https://mobile-banking-tawny.vercel.app/api/auth/register',
        userData
      )
      ...
      <div className='max-w z-20 relative min-h-screen flex items-center justify-center lg:p-6 md:p-5 my-6'>
        <div className='md:w-1/2 lg:w-1/2 mx-auto'>
          <div className='w-11/12 m-auto bg-gray-500 bg-opacity-30 rounded-lg p-5 shadow-md shadow-black'>
            <h1 className='text-3xl font-bold text-center pb-3 border-b-4 rounded-full'>
              Register
            </h1>
            <form
            ...
            >
              <h1 className='text- text-white'>
                {' '}
                Email and NID and Number must be uniqe
              </h1>
              <input
                type='text'
              ...
              <select
                ...
                className='input input-bordered w-full rounded-sm bg-transparent'
              >
