...
const OverView = () => {
  ...
  return (
    <div className=' text-black'>
      <h1 className='text-black text-2xl font-bold w-full border-b-2 py-4'>
        OverView
      </h1>
      ...
      <div className='p-3 my-8'>
        <div className='flex gap-3 flex-wrap'>
          <h1 className='p-2 rounded-sm bg-slate-200 text-xl text-black'>
            Total Balances : <span className='text-3xl'>{totalBalances}</span>{' '}
            TK
          </h1>
          <h1 className='p-2 rounded-sm bg-slate-200 text-xl text-black'>
            Total Transaction:{' '}
            <span className='text-3xl'>{allTrans?.length}</span>
          </h1>
        </div>
